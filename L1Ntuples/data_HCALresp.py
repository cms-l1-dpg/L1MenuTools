...
process.MessageLogger.suppressWarning = cms.untracked.vstring(
    'l1PhaseIITree', 'l1UpgradeTfMuonEmuTree', 'l1CaloTowerTree', 'l1AXOEmuTree',
...
process.GlobalTag = GlobalTag(process.GlobalTag, '140X_dataRun3_HLT_v3', 'Tag,HcalL1TriggerObjectsRcd,sqlite_file:/afs/cern.ch/user/c/caruta/public/L1Tstudies/HcalL1TriggerObjects_Run3Feb2025_11.db')
